...
async function quickRegistrationTest() {
  ...
  try {
    ...
    // Fill form using the IDs we discovered
    await page.type('input[id="form.email"]', testUser.email);
    console.log('✅ Email filled');
    
    await page.type('input[id="form.password"]', testUser.password);
    console.log('✅ Password filled');
    
    await page.type('input[id="form.passwordConfirmation"]', testUser.password);
    console.log('✅ Password confirmation filled');

    // Try to fill name if field exists
    try {
      await page.type('input[id="form.name"]', testUser.name);
